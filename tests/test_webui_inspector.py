...
def test_review_queue_inspector_api_returns_read_only_memory_os_state(monkeypatch):
    ...
    def fake_memory_os_inspector_payload(*, limit=20):
        return {
            ...
            "knowledge_pr_review_state": {
                "knowledge_pr_count": 1,
                "memory_ci_run_count": 1,
                "ci_blocked_count": 1,
                "items": [{"knowledge_pr_id": "kpr:book", "latest_ci_run_id": "mci:book"}],
                "write_performed": False,
            },
        }
    ...
    assert payload["knowledge_pr_review_state"]["items"][0]["knowledge_pr_id"] == "kpr:book"
    assert payload["knowledge_pr_review_state"]["write_performed"] is False
