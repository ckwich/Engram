...
def test_classify_engram_processes_for_this_checkout():
    server_proc = _proc(101, r'"C:\Python\python.exe" "C:\Dev\Engram\server.py"')
    daemon_proc = _proc(102, r'"C:\Python\python.exe" "C:\Dev\Engram\engramd.py"')
    health_proc = _proc(
        103,
        r'"C:\Python\python.exe" "C:\Dev\Engram\engramd.py" --health',
    )
...
def test_process_hygiene_report_marks_explicit_stop_candidates():
    processes = [
        ...
        _proc(103, r'"C:\Python\python.exe" "C:\Dev\Engram\server.py"', parent_pid=101),
    ]
...
def test_stop_server_pids_only_stops_exact_this_checkout_server_processes():
    processes = [
        ...
        _proc(104, r'"C:\Python\python.exe" "C:\Dev\Engram\server.py"'),
    ]
    killed = []
