...
class SearchPayload(TypedDict):
    ...
    backend_used: NotRequired[str]
    primary_backend: NotRequired[str]
    fallback_used: NotRequired[bool]
    fallback_reason: NotRequired[str | None]
    memory_os_retrieval_ready: NotRequired[bool]
    memory_os_retrieval_status: NotRequired[str | None]
    memory_os_retrieval_state: NotRequired[dict[str, object] | None]
