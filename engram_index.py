...
Usage:
  python engram_index.py --project C:/Projects/MyProject --mode bootstrap
  python engram_index.py --project C:/Projects/MyProject --mode evolve
  python engram_index.py --project C:/Projects/MyProject --mode full --force
  python engram_index.py --project C:/Projects/MyProject --init
  python engram_index.py --project C:/Projects/MyProject --install-hook
"""
import argparse
import hashlib
import json
...
ENGRAM_ROOT = Path(__file__).parent
DEFAULT_MAX_FILE_SIZE_KB = 100
DEFAULT_PLANNING_PATHS = ["PROJECT.md", "AGENTS.md"]
...
ENGRAM_INDEX = {engram_index_literal}
...
def run_install_hook(project_root: Path) -> None:
    ...
    hook_content = HOOK_TEMPLATE.format(
        venv_python_literal=json.dumps(str(venv_python)),
        engram_index_literal=json.dumps(str(engram_index)),
