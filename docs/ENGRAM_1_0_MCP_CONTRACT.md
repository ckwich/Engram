...
| `prepare_document_disassembly` | beta | `dict{disassembly, error}` | No-write local PDF page/text/image inventory; uses local tools when available and does not promote memory. |
