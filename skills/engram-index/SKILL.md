...
→ `C:/Dev/Engram/venv/Scripts/python.exe C:/Dev/Engram/engram_index.py --project "C:/Dev/Sylvara" --mode bootstrap`

User: `/engram-index evolve billing`
→ `C:/Dev/Engram/venv/Scripts/python.exe C:/Dev/Engram/engram_index.py --project "C:/Dev/Sylvara" --mode evolve --domain billing`

User: `/engram-index dry-run`
→ `C:/Dev/Engram/venv/Scripts/python.exe C:/Dev/Engram/engram_index.py --project "C:/Dev/Sylvara" --mode bootstrap --dry-run`

User: `/engram-index install hook`
→ `C:/Dev/Engram/venv/Scripts/python.exe C:/Dev/Engram/engram_index.py --project "C:/Dev/Sylvara" --install-hook`
