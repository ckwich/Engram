...
def memory_protocol() -> dict[str, Any]:
    ...
    return {
        ...
        "knowledge_contract": {
            ...
            "scope": "project_orientation, source_orientation, document_orientation, review_preparation, evidence_audit, graph_evidence",
        },
        "aliases": {
...
async def query_knowledge(request: dict[str, Any]) -> dict[str, Any]:
    ...
    document_orientation, review_preparation, evidence_audit, and
    graph_evidence requests with citations, freshness, policy, budget, planner,
    and explicit errors. This tool is read-only.
    """
    try:
